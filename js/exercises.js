...
→ IN kết quả</pre>`,rb:[{desc:'In đúng 7 kết quả với print()',kw:'print',pts:4,hint:''},{desc:'Dùng đúng 7 toán tử (+,-,*,/,//,%,**)',kw:'**',pts:4,hint:''},{desc:'Có chú thích # giải thích',kw:'#',pts:2,hint:''}],errors:['Nhầm <code>//</code> (chia nguyên) với <code>/</code> (chia thực)','Nhầm <code>**</code> (lũy thừa) với <code>^</code> (XOR trong Python)']},
...
→ XÁC ĐỊNH kiểu từng biến
→ TÍNH kết quả theo thứ tự từ trên xuống
→ IN kết quả</pre>`,rb:[{desc:'Khai báo đủ 4 biến đúng kiểu',kw:'True',pts:3,hint:''},{desc:'Dùng type() in kiểu dữ liệu',kw:'type',pts:4,hint:''},{desc:'In đúng 4 kiểu',kw:'print',pts:2,hint:''},{desc:'Có chú thích',kw:'#',pts:1,hint:''}],errors:['Nhầm chuỗi: <code>ten = Nguyen An</code> (thiếu dấu nháy)','Nhầm bool: <code>True</code> (chữ hoa T) không phải <code>true</code>']},
...
→ XÁC ĐỊNH kiểu từng biến
→ TÍNH kết quả theo thứ tự từ trên xuống
→ IN kết quả</pre>`,rb:[{desc:'Gán đồng thời a,b,c trên 1 dòng',kw:'a, b, c',pts:4,hint:''},{desc:'In đúng tổng 30',kw:'print',pts:3,hint:''},{desc:'Hoán đổi không dùng biến phụ',kw:'a, b = b, a',pts:3,hint:''}],errors:['Dùng biến phụ khi hoán đổi (không dùng kỹ thuật gán đồng thời)','Viết <code>a,b,c=5,10,15</code> (thiếu khoảng trắng — vẫn chạy được nhưng khó đọc)']},
...
→ XÁC ĐỊNH kiểu từng biến
→ TÍNH kết quả theo thứ tự từ trên xuống
→ IN kết quả</pre>`,rb:[{desc:'In đúng x=10',kw:'print',pts:3,hint:''},{desc:'In đúng y=4',kw:'print',pts:4,hint:''},{desc:'In đúng z=2',kw:'print',pts:3,hint:''}],errors:['Tính sai vì không chú ý thứ tự: x đã đổi sang 10 trước khi tính z','Nhầm <code>z = x - y = 10 - 8 = 2</code> (y lúc này vẫn là 8, chưa cập nhật)']},
...
→ XÁC ĐỊNH kiểu từng biến
→ TÍNH kết quả theo thứ tự từ trên xuống
→ IN kết quả</pre>`,rb:[{desc:'In đúng kết quả thực tế 18.0 và 38',kw:'18.0',pts:3,hint:''},{desc:'Sửa đúng biểu thức 1: (7+8+9)/3',kw:'(7',pts:3,hint:''},{desc:'Sửa đúng biểu thức 2: (2+3)**2*4',kw:'(2',pts:4,hint:''}],errors:['Không biết ưu tiên: <code>**</code> > <code>*,/</code> > <code>+,-</code>','Thêm ngoặc sai chỗ']},
...
IN kết quả ra màn hình (print)</pre>`,rb:[{desc:'Nhập float bằng float(input())',kw:'float',pts:3,hint:''},{desc:'Tính đúng chu vi = 2*(dai+rong)',kw:'chu_vi',pts:3,hint:''},{desc:'Tính đúng diện tích = dai*rong',kw:'dien_tich',pts:3,hint:''},{desc:'In kết quả đúng định dạng',kw:'print',pts:1,hint:''}],errors:['Dùng <code>input()</code> không ép kiểu → TypeError khi tính','Công thức sai: <code>dai + rong</code> thay vì <code>2*(dai+rong)</code>']},
...
NHẬP dữ liệu vào biến (input)
TÍNH toán sử dụng các toán tử
IN kết quả ra màn hình (print)</pre>`,rb:[{desc:'Nhập 3 điểm bằng float(input())',kw:'float',pts:2,hint:''},{desc:'Tính TB = (d1+d2+d3)/3',kw:'d1',pts:2,hint:''},{desc:'Dùng if-elif-else phân loại',kw:'if',pts:3,hint:''},{desc:'In TB đúng 2 chữ số thập phân',kw:':.2f',pts:2,hint:''},{desc:'Có chú thích',kw:'#',pts:1,hint:''}],errors:['Thiếu dấu <code>:</code> sau if/for/while/def','Thụt lề sai (dùng Tab thay vì 4 dấu cách)','Nhầm <code>=</code> (gán) với <code>==</code> (so sánh)','Quên ép kiểu: <code>int(input())</code> thay vì <code>input()</code>']},
...
NHẬP dữ liệu vào biến (input)
TÍNH toán sử dụng các toán tử
IN kết quả ra màn hình (print)</pre>`,rb:[{desc:'Nhập C bằng float(input())',kw:'float',pts:2,hint:''},{desc:'Tính đúng F = C*9/5+32',kw:'F',pts:4,hint:''},{desc:'Tính đúng K = C+273.15',kw:'K',pts:3,hint:''},{desc:'In đúng 2 kết quả',kw:'print',pts:1,hint:''}],errors:['Sai thứ tự toán tử: <code>C*9/5+32</code> đúng, <code>C*9/(5+32)</code> sai','Quên ép kiểu float khi nhập']},
...
NHẬP dữ liệu vào biến (input)
TÍNH toán sử dụng các toán tử
IN kết quả ra màn hình (print)</pre>`,rb:[{desc:'Nhập kWh bằng float(input())',kw:'float',pts:1,hint:''},{desc:'Dùng if-elif tính đúng 3 bậc',kw:'elif',pts:4,hint:''},{desc:'Tính đúng: 50×1678+50×1734+20×2014=210880',kw:'1678',pts:3,hint:''},{desc:'In kết quả dạng số nguyên',kw:'int',pts:2,hint:''}],errors:['Tính sai phần vượt: phải là <code>(kwh-50)*1734</code> không phải <code>kwh*1734</code>','Nhầm đơn giá: nhân toàn bộ kwh với giá bậc cao nhất']},
...
XỬ LÝ trường hợp đặc biệt (ví dụ: chia cho 0)</pre>`,rb:[{desc:'Nhập 2 số float và phép toán',kw:'float',pts:2,hint:''},{desc:'Xử lý đúng 7 phép toán bằng if-elif',kw:'elif',pts:3,hint:''},{desc:'Xử lý chia cho 0 (ZeroDivisionError)',kw:'if b == 0',pts:3,hint:''},{desc:'In đúng định dạng: a op b = kq',kw:'print',pts:2,hint:''}],errors:['Quên xử lý trường hợp chia cho 0','Nhầm <code>**</code> với <code>^</code> (XOR, không phải lũy thừa)']},
...
TÍNH toán nhiều bước phức tạp
ĐỊNH DẠNG output đẹp với f-string
XỬ LÝ trường hợp đặc biệt (ví dụ: chia cho 0)</pre>`,rb:[{desc:'Tính ngày: giây//86400',kw:'86400',pts:3,hint:''},{desc:'Tính giờ: còn_lại//3600',kw:'3600',pts:3,hint:''},{desc:'Tính phút và giây: //60 và %60',kw:'60',pts:3,hint:''},{desc:'In đúng định dạng',kw:'ngày',pts:1,hint:''}],errors:['Sai thứ tự: phải tính ngày → giờ → phút → giây','Nhầm 1 ngày = 84600 giây (đúng: 86400)']},
...
TÍNH toán nhiều bước phức tạp
ĐỊNH DẠNG output đẹp với f-string
XỬ LÝ trường hợp đặc biệt (ví dụ: chia cho 0)</pre>`,rb:[{desc:'Nhập 5 điểm bằng float',kw:'float',pts:2,hint:''},{desc:'Công thức đúng: (T*2+V*2+A+L+H)/7',kw:'2',pts:3,hint:''},{desc:'Xếp loại đúng 4 mức',kw:'elif',pts:3,hint:''},{desc:'In bảng có đường viền đẹp',kw:'╔',pts:2,hint:''}],errors:['Sai mẫu số: tổng hệ số = 2+2+1+1+1 = 7 (không phải 5)','Quên nhân hệ số 2 cho Toán và Văn']},
...
THEO DÕI giá trị từng biến
TÍNH kết quả theo thứ tự thực thi
IN kết quả (hoặc điền vào chỗ trống)</pre>`,rb:[{desc:'Cách 1: nối chuỗi với str()',kw:'str(',pts:3,hint:''},{desc:'Cách 2: print nhiều giá trị',kw:'sep',pts:3,hint:''},{desc:'Cách 3: f-string với :.2f',kw:'f"',pts:4,hint:''}],errors:['Thiếu dấu <code>:</code> sau if/for/while/def','Thụt lề sai (Tab thay vì 4 dấu cách)','Nhầm <code>=</code> (gán) với <code>==</code> (so sánh)','Quên ép kiểu: cần <code>int(input())</code>']},
...
GHI CHÉP giá trị biến sau mỗi lệnh
DỰ ĐOÁN output trước khi chạy
CHẠY kiểm tra và so sánh</pre>`,rb:[{desc:'Sửa đúng: int(input()) cho cả a,b',kw:'int',pts:4,hint:''},{desc:'Giải thích lỗi: + chuỗi thay vì + số',kw:'#',pts:3,hint:''},{desc:'Kết quả in đúng: 8',kw:'print',pts:3,hint:''}],errors:['Thiếu dấu <code>:</code> sau if/for/while/def','Thụt lề sai (Tab thay vì 4 dấu cách)','Nhầm <code>=</code> (gán) với <code>==</code> (so sánh)','Quên ép kiểu: cần <code>int(input())</code>']},
...
GHI CHÉP giá trị biến sau mỗi lệnh
DỰ ĐOÁN output trước khi chạy
CHẠY kiểm tra và so sánh</pre>`,rb:[{desc:'In đúng bình phương 25',kw:'25',pts:3,hint:''},{desc:'In đúng căn 2.2361 với :.4f',kw:':.4f',pts:4,hint:''},{desc:'In đúng dòng 3',kw:'11',pts:3,hint:''}],errors:['Thiếu dấu <code>:</code> sau if/for/while/def','Thụt lề sai (Tab thay vì 4 dấu cách)','Nhầm <code>=</code> (gán) với <code>==</code> (so sánh)','Quên ép kiểu: cần <code>int(input())</code>']},
...
IN KẾT QUẢ đúng định dạng</pre>`,rb:[{desc:'Nhập float cho cân và chiều cao',kw:'float',pts:2,hint:''},{desc:'Tính BMI = can/cao**2',kw:'can',pts:3,hint:''},{desc:'Phân loại đúng 4 mức',kw:'elif',pts:3,hint:''},{desc:'In BMI 2 chữ số thập phân',kw:':.2f',pts:2,hint:''}],errors:['Dùng 3 <code>if</code> riêng lẻ thay vì <code>if-elif-else</code>','Thiếu dấu <code>:</code> sau điều kiện','Thụt lề khối lệnh không đều']},
...
NHẬP dữ liệu vào (input + ép kiểu)
TÍNH TOÁN / XỬ LÝ theo yêu cầu
IN KẾT QUẢ đúng định dạng</pre>`,rb:[{desc:'Nhập số quyển int và đơn giá float',kw:'int',pts:2,hint:''},{desc:'Tính tổng = so_quyen * don_gia',kw:'*',pts:2,hint:''},{desc:'Áp dụng giảm giá đúng 3 mức',kw:'elif',pts:3,hint:''},{desc:'In tổng có dấu phân cách ngàn',kw:':,',pts:3,hint:''}],errors:['Dùng 3 <code>if</code> riêng lẻ thay vì <code>if-elif-else</code>','Thiếu dấu <code>:</code> sau điều kiện','Thụt lề khối lệnh không đều']},
...
TÌM dòng gây ra lỗi
GIẢI THÍCH nguyên nhân
SỬA và kiểm tra lại</pre>`,rb:[{desc:'Sửa lỗi 1: dùng str(x) hoặc f-string',kw:'str(',pts:3,hint:''},{desc:'Sửa lỗi 2: dùng :.2f',kw:':.2f',pts:4,hint:''},{desc:'Sửa lỗi 3: định dạng 2 chữ số',kw:'.2',pts:3,hint:''}],errors:['Thiếu dấu <code>:</code> sau if/for/while/def','Thụt lề sai (Tab thay vì 4 dấu cách)','Nhầm <code>=</code> (gán) với <code>==</code> (so sánh)','Quên ép kiểu: cần <code>int(input())</code>']},
...
SO SÁNH về: độ chính xác, tốc độ, dễ đọc
ĐO LƯỜNG bằng time hoặc đếm bước
KẾT LUẬN cách nào tốt hơn và khi nào</pre>`,rb:[{desc:'Dùng vòng lặp lồng nhau',kw:'for',pts:3,hint:''},{desc:'Căn cột bằng :4d hoặc tương đương',kw:':4',pts:4,hint:''},{desc:'Output đúng 5×5',kw:'print',pts:3,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
LẬP TRÌNH từng bước nhỏ
KIỂM TRA điều kiện biên và lỗi
HOÀN THIỆN giao diện và định dạng output</pre>`,rb:[{desc:'Nhập số tiền int',kw:'int',pts:2,hint:''},{desc:'Dùng vòng lặp qua các mệnh giá',kw:'for',pts:3,hint:''},{desc:'Tính đúng số tờ từng loại (//,%)',kw:'//,',pts:4,hint:''},{desc:'In đúng kết quả',kw:':,',pts:1,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
THEO DÕI giá trị từng biến
TÍNH kết quả theo thứ tự thực thi
IN kết quả (hoặc điền vào chỗ trống)</pre>`,rb:[{desc:'In đúng a=True',kw:'True',pts:3,hint:''},{desc:'In đúng c=False',kw:'False',pts:3,hint:''},{desc:'Tính đúng b=True (or)',kw:'or',pts:2,hint:''},{desc:'In đúng d=True',kw:'and',pts:2,hint:''}],errors:['Dùng 3 <code>if</code> riêng lẻ thay vì <code>if-elif-else</code>','Thiếu dấu <code>:</code> sau điều kiện','Thụt lề khối lệnh không đều']},
...
NHẬP dữ liệu vào (input + ép kiểu)
TÍNH TOÁN / XỬ LÝ theo yêu cầu
IN KẾT QUẢ đúng định dạng</pre>`,rb:[{desc:'Kiểm tra điều kiện tạo tam giác',kw:'a + b > c',pts:3,hint:''},{desc:'Phân loại đều: a==b==c',kw:'a == b == c',pts:2,hint:''},{desc:'Phân loại vuông: a²+b²=c²',kw:'**2',pts:3,hint:''},{desc:'Phân loại cân và thường',kw:'a == b',pts:2,hint:''}],errors:['Dùng 3 <code>if</code> riêng lẻ thay vì <code>if-elif-else</code>','Thiếu dấu <code>:</code> sau điều kiện','Thụt lề khối lệnh không đều']},
...
NHẬP dữ liệu vào (input + ép kiểu)
TÍNH TOÁN / XỬ LÝ theo yêu cầu
IN KẾT QUẢ đúng định dạng</pre>`,rb:[{desc:'Nhập kg=float và loại=str',kw:'float',pts:2,hint:''},{desc:'Xác định đúng giá cơ bản theo loại',kw:'elif',pts:3,hint:''},{desc:'Tính đúng phần vượt',kw:'kg - 1',pts:3,hint:''},{desc:'In phí đúng có dấu ngàn',kw:':,',pts:2,hint:''}],errors:['Dùng 3 <code>if</code> riêng lẻ thay vì <code>if-elif-else</code>','Thiếu dấu <code>:</code> sau điều kiện','Thụt lề khối lệnh không đều']},
...
NHẬP dữ liệu vào (input + ép kiểu)
TÍNH TOÁN / XỬ LÝ theo yêu cầu
IN KẾT QUẢ đúng định dạng</pre>`,rb:[{desc:'Kiểm tra > 0',kw:'if rut > 0',pts:1,hint:''},{desc:'Kiểm tra bội số 50000',kw:'% 50000',pts:3,hint:''},{desc:'Kiểm tra không vượt 10 triệu',kw:'10000000',pts:2,hint:''},{desc:'Kiểm tra số dư tối thiểu',kw:'50000',pts:3,hint:''},{desc:'In kết quả đúng',kw:':,',pts:1,hint:''}],errors:['Dùng 3 <code>if</code> riêng lẻ thay vì <code>if-elif-else</code>','Thiếu dấu <code>:</code> sau điều kiện','Thụt lề khối lệnh không đều']},
...
TÌM dòng gây ra lỗi
GIẢI THÍCH nguyên nhân
SỬA và kiểm tra lại</pre>`,rb:[{desc:'Dùng if-elif-else đúng 4 mức',kw:'elif',pts:3,hint:''},{desc:'Kiểm thử đủ 8 trường hợp biên',kw:'for',pts:3,hint:''},{desc:'Kết quả biên đúng (1,4→0%, 5,9→5%)',kw:'Giảm',pts:4,hint:''}],errors:['Dùng 3 <code>if</code> riêng lẻ thay vì <code>if-elif-else</code>','Thiếu dấu <code>:</code> sau điều kiện','Thụt lề khối lệnh không đều']},
...
SO SÁNH về: độ chính xác, tốc độ, dễ đọc
ĐO LƯỜNG bằng time hoặc đếm bước
KẾT LUẬN cách nào tốt hơn và khi nào</pre>`,rb:[{desc:'Nhập điểm float và hạnh kiểm str',kw:'float',pts:2,hint:''},{desc:'Kết hợp 2 điều kiện bằng and',kw:'and',pts:4,hint:''},{desc:'Phân loại đúng 4 danh hiệu',kw:'elif',pts:4,hint:''}],errors:['Dùng 3 <code>if</code> riêng lẻ thay vì <code>if-elif-else</code>','Thiếu dấu <code>:</code> sau điều kiện','Thụt lề khối lệnh không đều']},
...
LẬP TRÌNH từng bước nhỏ
KIỂM TRA điều kiện biên và lỗi
HOÀN THIỆN giao diện và định dạng output</pre>`,rb:[{desc:'Phân loại đúng 5 loại khách',kw:'elif',pts:3,hint:''},{desc:'Tính đúng theo khoảng cách',kw:'elif',pts:2,hint:''},{desc:'Xử lý giờ cao điểm +20%',kw:'*1.2',pts:3,hint:''},{desc:'In giá có dấu ngàn',kw:':,',pts:2,hint:''}],errors:['Dùng 3 <code>if</code> riêng lẻ thay vì <code>if-elif-else</code>','Thiếu dấu <code>:</code> sau điều kiện','Thụt lề khối lệnh không đều']},
...
THEO DÕI giá trị từng biến
TÍNH kết quả theo thứ tự thực thi
IN kết quả (hoặc điền vào chỗ trống)</pre>`,rb:[{desc:'In đúng range(5)',kw:'[0, 1',pts:3,hint:''},{desc:'In đúng range(0,10,2)',kw:'[0, 2',pts:4,hint:''},{desc:'In đúng range đếm lùi',kw:'5, 4',pts:3,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
THEO DÕI giá trị từng biến
TÍNH kết quả theo thứ tự thực thi
IN kết quả (hoặc điền vào chỗ trống)</pre>`,rb:[{desc:'Cách 1: for x in A',kw:'for x in',pts:4,hint:''},{desc:'Cách 2: for i in range(len(A))',kw:'range(len',pts:3,hint:''},{desc:'Dùng end=" " để in cùng hàng',kw:'end=',pts:3,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
GHI CHÉP giá trị biến sau mỗi lệnh
DỰ ĐOÁN output trước khi chạy
CHẠY kiểm tra và so sánh</pre>`,rb:[{desc:'In đúng dòng 1 (1 dấu *)',kw:'* ',pts:3,hint:''},{desc:'In đúng dòng 3 (3 dấu *)',kw:'***',pts:4,hint:''},{desc:'Dùng end="" đúng',kw:'end=',pts:3,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
GHI CHÉP giá trị biến sau mỗi lệnh
DỰ ĐOÁN output trước khi chạy
CHẠY kiểm tra và so sánh</pre>`,rb:[{desc:'In đúng đánh số 1–4',kw:'enumerate',pts:3,hint:''},{desc:'Giải thích start=1',kw:'start=1',pts:3,hint:''},{desc:'Viết lại với range',kw:'range',pts:4,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
NHẬP dữ liệu vào (input + ép kiểu)
TÍNH TOÁN / XỬ LÝ theo yêu cầu
IN KẾT QUẢ đúng định dạng</pre>`,rb:[{desc:'Nhập n bằng int(input())',kw:'int',pts:2,hint:''},{desc:'Dùng for range(1,11)',kw:'range(1, 11)',pts:3,hint:''},{desc:'In đúng định dạng n x i = kq',kw:'x',pts:3,hint:''},{desc:'Kết quả đúng (5×10=50)',kw:'= 50',pts:2,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
NHẬP dữ liệu vào (input + ép kiểu)
TÍNH TOÁN / XỬ LÝ theo yêu cầu
IN KẾT QUẢ đúng định dạng</pre>`,rb:[{desc:'Khởi tạo a=0, b=1',kw:'a, b = 0, 1',pts:3,hint:''},{desc:'Vòng lặp n lần in và cập nhật',kw:'for',pts:3,hint:''},{desc:'Cập nhật đúng: a,b=b,a+b',kw:'a, b = b',pts:4,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
NHẬP dữ liệu vào (input + ép kiểu)
TÍNH TOÁN / XỬ LÝ theo yêu cầu
IN KẾT QUẢ đúng định dạng</pre>`,rb:[{desc:'Nhập n điểm vào list',kw:'append',pts:2,hint:''},{desc:'Dùng max(), min(), sum()',kw:'max',pts:3,hint:''},{desc:'Đếm số đạt (≥5.0)',kw:'if d >= 5',pts:3,hint:''},{desc:'In đúng 3 dòng kết quả',kw:'Cao nhất',pts:2,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
SO SÁNH về: độ chính xác, tốc độ, dễ đọc
ĐO LƯỜNG bằng time hoặc đếm bước
KẾT LUẬN cách nào tốt hơn và khi nào</pre>`,rb:[{desc:'Cách 1: for + append',kw:'append',pts:3,hint:''},{desc:'Cách 2: list comprehension',kw:'[x**2',pts:4,hint:''},{desc:'In True (giống nhau)',kw:'True',pts:3,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
LẬP TRÌNH từng bước nhỏ
KIỂM TRA điều kiện biên và lỗi
HOÀN THIỆN giao diện và định dạng output</pre>`,rb:[{desc:'Duyệt từng ký tự bằng for',kw:'for',pts:2,hint:''},{desc:'Kiểm tra isalpha()',kw:'isalpha',pts:3,hint:''},{desc:'Dịch đúng: (ord-base+k)%26+base',kw:'ord',pts:4,hint:''},{desc:'Giải mã ngược lại đúng',kw:'- k',pts:1,hint:''}],errors:['Sai phạm vi: <code>range(1,n)</code> thiếu n → dùng <code>range(1,n+1)</code>','Dùng <code>=</code> thay vì <code>+=</code> khi tích lũy tổng','Quên biến đếm/tổng chưa khởi tạo']},
...
LẬP TRÌNH từng bước nhỏ
KIỂM TRA điều kiện biên và lỗi
HOÀN THIỆN giao diện và định dạng output</pre>`,rb:[{desc:'Duyệt 1..10000 bằng for',kw:'range(1, 10001)',pts:2,hint:''},{desc:'Hàm tính tổng ước',kw:'def tong_uoc',pts:3,hint:''},{desc:'Tìm đúng 4 số hoàn hảo: 6,28,496,8128',kw:'28',pts:4,hint:''},{desc:'Có chú thích',kw:'#',pts:1,hint:''}],errors:['Quên <code>return</code> → hàm trả về None','Gọi hàm trước khi định nghĩa','Tham số thiếu hoặc thừa khi gọi hàm']},
...
ĐỌC code từng dòng
THEO DÕI giá trị từng biến
INDIELT kết quả</pre>`,rb:[{desc:'In đúng 1 2 3 4 5',kw:'1 2 3',pts:4,hint:''},{desc:'Dùng while đúng cú pháp',kw:'while',pts:4,hint:''},{desc:'Có cập nhật i += 1',kw:'i += 1',pts:2,hint:''}],errors:['Quên cập nhật biến điều kiện → lặp vô tận','Sai hướng: i+=1 thay vì i-=1 khi đếm lùi']},
...
NHẬP dữ liệu (input + ép kiểu)
TINH TOÁN / XỬ LÝ
IN kết quả</pre>`,rb:[{desc:'Nhập 2 số int',kw:'int',pts:2,hint:''},{desc:'Dùng while b != 0: a,b=b,a%b',kw:'while b != 0',pts:4,hint:''},{desc:'Tính BCNN = a*b//ucln',kw:'a * b',pts:4,hint:''}],errors:['Quên cập nhật biến điều kiện → lặp vô tận','Sai hướng: i+=1 thay vì i-=1 khi đếm lùi']},
...
ĐỌC code lỗi
XÁC ĐỊNH loại lỗi
SỬA và kiểm tra</pre>`,rb:[{desc:'Viết đúng bằng for',kw:'for i in range',pts:3,hint:''},{desc:'Viết đúng bằng while',kw:'while i <= n',pts:3,hint:''},{desc:'In True (cùng kết quả)',kw:'True',pts:4,hint:''}],errors:['Quên cập nhật biến điều kiện → lặp vô tận','Sai hướng: i+=1 thay vì i-=1 khi đếm lùi']},
...
KẾT LUẬN cách tốt nhất</pre>`,rb:[{desc:'Cài LinearSearch đếm bước',kw:'dem',pts:3,hint:''},{desc:'Cài BinarySearch đếm bước',kw:'while lo <= hi',pts:4,hint:''},{desc:'So sánh và nhận xét',kw:'print',pts:3,hint:''}],errors:['BinarySearch chỉ đúng với mảng đã SẮP XẾP','Sai điều kiện: lo <= hi (không phải lo < hi)']},
...
VIẾT 2+ cách giải
SO SÁNH tốc độ, độ chính xác
KẾT LUẬN cách tốt nhất</pre>`,rb:[{desc:'Dùng while sai_so > 0.0001',kw:'sai_so',pts:4,hint:''},{desc:'Tính đúng chuỗi Leibniz',kw:'1/(2*i-1)',pts:3,hint:''},{desc:'Đếm số hạng cần thiết',kw:'dem',pts:3,hint:''}],errors:['Quên cập nhật biến điều kiện → lặp vô tận','Sai hướng: i+=1 thay vì i-=1 khi đếm lùi']},
...
VIẾT 2+ cách giải
SO SÁNH tốc độ, độ chính xác
KẾT LUẬN cách tốt nhất</pre>`,rb:[{desc:'Dùng while dan_so < 120e6',kw:'while',pts:3,hint:''},{desc:'Tăng đúng 1.1% mỗi năm',kw:'*= 1.011',pts:4,hint:''},{desc:'Tính năm gấp đôi',kw:'200e6',pts:3,hint:''}],errors:['Quên cập nhật biến điều kiện → lặp vô tận','Sai hướng: i+=1 thay vì i-=1 khi đếm lùi']},
...
LẬP KẾ HOẠCH → mã giả
VIẾT CODE từng bước
KIỂM THỬ điều kiện biên</pre>`,rb:[{desc:'Thuật toán binary search: lo,hi,mid',kw:'lo, hi',pts:3,hint:''},{desc:'Cập nhật lo/hi theo câu trả lời',kw:'elif',pts:3,hint:''},{desc:'Xếp loại sau khi đoán đúng',kw:'Thiên tài',pts:4,hint:''}],errors:['Quên cập nhật biến điều kiện → lặp vô tận','Sai hướng: i+=1 thay vì i-=1 khi đếm lùi']},
...
LẬP KẾ HOẠCH → mã giả
VIẾT CODE từng bước
KIỂM THỬ điều kiện biên</pre>`,rb:[{desc:'Nhập và kiểm tra 1<=t<=3600',kw:'while True',pts:2,hint:''},{desc:'Hiển thị MM:SS đúng',kw:'//60',pts:3,hint:''},{desc:'Đếm ngược và in đúng',kw:'while t > 0',pts:4,hint:''},{desc:'In thông báo kết thúc',kw:'Hết giờ',pts:1,hint:''}],errors:['Quên cập nhật biến điều kiện → lặp vô tận','Sai hướng: i+=1 thay vì i-=1 khi đếm lùi']},
...
ĐỌC code từng dòng
THEO DÕI giá trị từng biến
INDIELT kết quả</pre>`,rb:[{desc:'In đúng sau append',kw:'append',pts:3,hint:''},{desc:'In đúng sau insert',kw:'insert',pts:3,hint:''},{desc:'In đúng sau remove',kw:'remove',pts:3,hint:''},{desc:'len=4',kw:'4',pts:1,hint:''}],errors:['Chỉ số bắt đầu từ 0, không phải 1','IndexError khi truy cập chỉ số ngoài phạm vi','Nhầm A.append(x) với A = A + [x]']},
...
ĐỌC code từng dòng
THEO DÕI giá trị từng biến
INDIELT kết quả</pre>`,rb:[{desc:'Nhập n bằng int(input())',kw:'int',pts:2,hint:''},{desc:'Nhập n số vào list',kw:'append',pts:3,hint:''},{desc:'In list đúng',kw:'print',pts:3,hint:''},{desc:'In tổng = sum(A)',kw:'sum',pts:2,hint:''}],errors:['Chỉ số bắt đầu từ 0, không phải 1','IndexError khi truy cập chỉ số ngoài phạm vi','Nhầm A.append(x) với A = A + [x]']},
...
TRACE code bước bước
DỰ ĐOÁN output trước
CHẠY và so sánh</pre>`,rb:[{desc:'In True (A==B về giá trị)',kw:'True',pts:4,hint:''},{desc:'In False (A is not B, khác object)',kw:'False',pts:3,hint:''},{desc:'Giải thích is vs ==',kw:'#',pts:3,hint:''}],errors:['Chỉ số bắt đầu từ 0, không phải 1','IndexError khi truy cập chỉ số ngoài phạm vi','Nhầm A.append(x) với A = A + [x]']},
...
NHẬP dữ liệu (input + ép kiểu)
TINH TOÁN / XỬ LÝ
IN kết quả</pre>`,rb:[{desc:'Nhập n số vào list',kw:'append',pts:2,hint:''},{desc:'Lọc chẵn: x%2==0',kw:'% 2 == 0',pts:4,hint:''},{desc:'Lọc lẻ: x%2!=0',kw:'% 2 != 0',pts:3,hint:''},{desc:'In đúng 2 list',kw:'print',pts:1,hint:''}],errors:['Chỉ số bắt đầu từ 0, không phải 1','IndexError khi truy cập chỉ số ngoài phạm vi','Nhầm A.append(x) với A = A + [x]']},
...
VIẾT 2+ cách giải
SO SÁNH tốc độ, độ chính xác
KẾT LUẬN cách tốt nhất</pre>`,rb:[{desc:'Cách 1: for+append',kw:'append',pts:2,hint:''},{desc:'Cách 2: LC',kw:'[x**2',pts:3,hint:''},{desc:'Đo thời gian bằng time',kw:'time.time',pts:3,hint:''},{desc:'So sánh kết quả True',kw:'True',pts:2,hint:''}],errors:['Chỉ số bắt đầu từ 0, không phải 1','IndexError khi truy cập chỉ số ngoài phạm vi','Nhầm A.append(x) với A = A + [x]']},
...
VIẾT 2+ cách giải
SO SÁNH tốc độ, độ chính xác
KẾT LUẬN cách tốt nhất</pre>`,rb:[{desc:'Đếm từng loại',kw:'count_gioi',pts:3,hint:''},{desc:'In đúng số học sinh mỗi loại',kw:'print',pts:3,hint:''},{desc:'Vẽ biểu đồ * tương ứng số lượng',kw:'*',pts:4,hint:''}],errors:['Chỉ số bắt đầu từ 0, không phải 1','IndexError khi truy cập chỉ số ngoài phạm vi','Nhầm A.append(x) với A = A + [x]']},
